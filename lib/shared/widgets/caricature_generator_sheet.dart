...
import 'package:nexa/services/caricature_service.dart';
...
class _CaricatureGeneratorSheetState extends State<CaricatureGeneratorSheet>
  ...
  late final CaricatureService _service;
  ...
  void initState() {
    super.initState();
    _service = CaricatureService(GetIt.I<ApiClient>());
  ...
  Future<void> _loadStyles() async {
    try {
      final resp = await _service.getStyles();
      if (!mounted) return;
      setState(() {
        _roles = resp.roles;
      ...
      setState(() {
        _loadingStyles = false;
        _error = AppLocalizations.of(context)?.failedToLoadStyles ?? 'Failed to load styles';
      });
    }
  }
  ...
  Widget _buildRoleSection() {
    ...
    final l10n = AppLocalizations.of(context)!;
    if (!_showAllRoles) {
      // Collapsed: show first N roles as flat chips + "See More"
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 4),
                Text(
                  l10n.higherDetailFacialPreservation,
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w500,
                    color: AppColors.textMuted,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            AppLocalizations.of(context)!.readyForNewLook,
            style: const TextStyle(
              fontSize: 17,
              fontWeight: FontWeight.w700,
              color: AppColors.primaryPurple,
          ...
          const SizedBox(height: 4),
          Text(
            AppLocalizations.of(context)!.hitButtonSeeMagic,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            AppLocalizations.of(context)!.usuallyTakes15Seconds,
            style: const TextStyle(fontSize: 13, color: AppColors.textMuted),
          ),
        ],
      ),
  ...
  Widget _buildAiDisclaimer() {
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 6),
        Text(
          AppLocalizations.of(context)!.aiGeneratedMayNotBeAccurate,
          style: TextStyle(
            fontSize: 12,
