...
// Script to generate a full year of realistic past events for testing
// Run with: docker exec nexa-api node dist/scripts/generate-year-events.js
...
function generateEventDate(year: number, month: number): Date {
